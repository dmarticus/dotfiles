...
launchctl unload ~/Library/LaunchAgents/com.dylan.disk-monitor.plist

# Start monitoring service
launchctl load ~/Library/LaunchAgents/com.dylan.disk-monitor.plist
...
Edit `/Users/dylan/.dotfiles/bin/check-disk-space`:
