...
description: Write bi-weekly sprint planning updates for the Feature Flags team. Automates PR fetching, sprint detection, and retro construction from the previous plan.
model: sonnet
color: pink
...
# Sprint Planning - Feature Flags

Generate a bi-weekly sprint planning update for the Feature Flags team, ready to post as a GitHub comment on the sprint planning issue.

## Team Configuration

**Team:** Feature Flags Product
**GitHub Team:** `PostHog/team-feature-flags`
**Project Board:** [PostHog Project 112](https://github.com/orgs/PostHog/projects/112/)
**Goals Page:** [(https://posthog.com/teams/feature-flags#goals](https://posthog.com/teams/feature-flags#goals)
...
```bash
gh api orgs/PostHog/teams/team-feature-flags/members --jq '.[].login'
```
...
```markdown
## Team Goals - Feature Flags

[Project Board](https://github.com/orgs/PostHog/projects/112)
