...
- **Plans**: `~/dev/ai/plans/{org}/{repo}/{slug}.md`
- **Notes**: `~/dev/ai/notes/`
...
- Branch names: `dmarticus/<slug>` or `dmarticus/<issue#>-<slug>`
...
- Prompt to create a new branch and worktree for each task.
  - Branch off main/master, named `dmarticus/<slug>` or `dmarticus/<issue#>-<slug>`.
